...
public class MapaSelector {
    ...
    private static final int[] bitmapsMenu = new int[]{R.drawable.characterselection,R.drawable.mezquita,R.drawable.mishimadojo};
    private static final int[] musicasMenu = new int[]{R.raw.coffeetalkadaywithcoffee,R.raw.coffeetalksunsetinthecity,R.raw.coffeetalkwaytoosoon};
