...
public class Terry extends Personaje{
    ...
    private void IniciaAnimaciones(){
        ...
        attackForward[0]=new Frame(Bitmap.createScaledBitmap(BitmapFactory.decodeResource(context.getResources(),R.drawable.terrykick1),width,height,true),false,this.isPlayer,0,20);
        attackForward[1]=new Frame(Bitmap.createScaledBitmap(BitmapFactory.decodeResource(context.getResources(),R.drawable.terrykick2),width,height,true),false,this.isPlayer,0,0);
        attackForward[2]=new Frame(Bitmap.createScaledBitmap(BitmapFactory.decodeResource(context.getResources(),R.drawable.terrykick3),width,height,true),true,this.isPlayer,20,0);
        attackForward[3]=new Frame(Bitmap.createScaledBitmap(BitmapFactory.decodeResource(context.getResources(),R.drawable.terrykick4),width,height,true),true,this.isPlayer,20,0);
        attackForward[4]=new Frame(Bitmap.createScaledBitmap(BitmapFactory.decodeResource(context.getResources(),R.drawable.terrykick5),width,height,true),false,this.isPlayer,0,0);
